...
expts = ExptFormationEnergy.objects.filter(
    dft=False, source__in=["ssub", "konig", "iit", "corrections"]
)

fitall = element_groups["all"]
fitstd = ["H", "N", "O", "F", "Cl", "Hg", "Br", "Na", "Sn", "Ti", "I", "P", "S"]

elts, hubs = fit(calculations=calcs, experiments=expts, fit_for=fitstd)

chem_pots["standard"] = {"elements": elts, "hubbards": hubs}
