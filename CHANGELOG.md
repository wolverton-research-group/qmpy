...
- Migrate the OQMD API implementation from OPTIMADE 1.0.0 to 1.2.0.
- Add v1.2 discovery metadata, version negotiation, schemas, and JSON:API errors.
- Update to the OPTIMADE v1.2 filter grammar.
- Add standard structure property metadata and Python 3.9 tests.
- Keep Python 3.9 and Django 2.2 as the supported runtime for this release.
- Integrate yearly qmdb download changes.
- Add rendering fixes to fix GCLP.
