...
Clazz.load (["J.util.AxisAngle4f", "$.P3", "$.V3"], "J.exportjs.Exporter", ["java.lang.Float", "J.util.Logger", "$.TextFormat"], function () {
...
this.out = viewer.openOutputChannel (privateKey, this.fileName, true);
} catch (e) {
