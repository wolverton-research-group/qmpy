...
Clazz.load (["J.api.Triangulator", "J.util.P3i"], "J.util.TriangleData", ["J.util.ArrayUtil", "$.BS", "$.BSUtil", "$.P3"], function () {
...
var result = J.util.P3.newP (vertices[v2]);
...
var polygons = J.util.ArrayUtil.newInt2 (triangles.length >> 2);
v.addLast (polygons);
