...
this.mouse = this.apiPlatform.getMouseManager (this.privateKey, this, this.actionManager);
...
this.getScriptManager ().openFileAsync (fileName, pdbCartoons);
}, "~S,~B");
...
function () {
return this.getOutputManager ().getWrappedState (null, null, null, false);
});
...
{
if (this.isWebGL)return null
}return this.getOutputManager ().getImageAsBytes (params);
}, "java.util.Map");
...
try {
if (this.isHeadless ()) this.createImage (this.headlessImage);
} catch (e) {
if (Clazz.exceptionOf (e, Exception)) {
} else {
throw e;
...
}, "J.util.BS,J.io.JmolOutputChannel");
...
return (!this.haveAccess (J.viewer.Viewer.ACCESS.ALL) ? null : this.getFileAdapter ().openOutputChannel (privateKey, this.fileManager, fileName, asWriter, false));
}, "~N,~S,~B");
...
$_M(c$, "openLogFile", 
function (privateKey, asAppend) {
return (!this.haveAccess (J.viewer.Viewer.ACCESS.ALL) ? null : this.getFileAdapter ().openOutputChannel (privateKey, this.fileManager, this.logFileName, true, asAppend));
}, "~N,~B");
$_M(c$, "setLogFile", 
($fz = function (value) {
return this.getOutputManager ().setLogFile (value);
}, $fz.isPrivate = true, $fz), "~S");
