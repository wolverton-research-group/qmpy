...
}, "J.modelset.ModelSet,~N,J.api.SymmetryInterface,J.util.P3,J.util.P3,~S");
...
Clazz.overrideMethod (c$, "hasLatticeCentering", 
function () {
return this.spaceGroup.hasLatticeCentering;
});
...
this.hasLatticeCentering = false;
this.xyzList = null;
...
if (!this.hasLatticeCentering && this.xyzList.containsKey (J.util.TextFormat.simpleReplace (J.util.TextFormat.simpleReplace (xyz, "+1/2", ""), "+1/2", ""))) this.hasLatticeCentering = true;
...
Clazz.declarePackage ("J.symmetry");
Clazz.load (["J.util.Matrix4f"], "J.symmetry.SymmetryOperation", ["java.lang.Float", "J.util.Escape", "$.JmolList", "$.Logger", "$.Measure", "$.P3", "$.P4", "$.Parser", "$.Quaternion", "$.SB", "$.TextFormat", "$.V3"], function () {
c$ = Clazz.decorateAsClass (function () {
...
return J.symmetry.SymmetryOperation.getDescription (modelSet, this, this.xyzOriginal, uc, pt00, ptTarget, id);
}, "J.modelset.ModelSet,J.api.SymmetryInterface,J.util.P3,J.util.P3,~S");
c$.getDescription = $_M(c$, "getDescription", 
($fz = function (modelSet, m, xyzOriginal, uc, pt00, ptTarget, id) {
...
}, $fz.isPrivate = true, $fz), "J.modelset.ModelSet,J.symmetry.SymmetryOperation,~S,J.api.SymmetryInterface,J.util.P3,J.util.P3,~S");
...
return  new J.util.Tensor ().getTensorFromEigenVectors (J.symmetry.UnitCell.unitVectors, eigenValues, "iso", "Uiso=" + f);
