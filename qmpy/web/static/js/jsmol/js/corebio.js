...
Clazz.declarePackage ("J.modelsetbio");
Clazz.load (["J.util.V3"], "J.modelsetbio.BioPolymer", ["java.lang.Float", "java.util.Hashtable", "J.util.BS", "$.Escape", "$.JmolList", "$.Logger", "$.P3", "$.Quaternion", "$.TextFormat"], function () {
c$ = Clazz.decorateAsClass (function () {
this.monomers = null;
this.model = null;
...
}, "J.viewer.Viewer,J.modelsetbio.BioPolymer,~S,~S,~N,~N,J.util.BS,J.util.BS,~B,~B,~B,~A,J.io.JmolOutputChannel,J.util.SB,J.util.BS");
...
}, $fz.isPrivate = true, $fz), "J.viewer.Viewer,~N,~N,J.modelsetbio.BioPolymer,~S,~S,~N,J.util.BS,J.util.BS,~B,~B,~B,~B,~B,~B,~N,~B,~B,~A,J.io.JmolOutputChannel,J.util.SB,J.util.BS");
...
return;
}, "J.viewer.Viewer,~S,~S,~N,~N,J.util.BS,J.util.BS,~B,~B,~B,~A,J.io.JmolOutputChannel,J.util.SB,J.util.BS");
$_M(c$, "getType", 
function () {
return this.type;
});
...
}, "J.viewer.Viewer,~S,~S,~B,J.util.BS,J.io.JmolOutputChannel,~A,J.util.SB,J.util.BS");
Clazz.defineStatics (c$,
