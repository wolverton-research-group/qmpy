...
urlpatterns += [
    ...
    url(r"^optimade/v1\.2/info$", views.OptimadeInfoData),
    url(r"^optimade/v1\.2/structures$", views.OptimadeStructureList.as_view()),
    url(
        r"^optimade/v1\.2/structures/(?P<pk>[0-9]+)/?$",
        views.OptimadeStructureDetail.as_view(),
    ),
    url(r"^optimade/v1\.2/info/structures$", views.OptimadeStructuresInfoData),
    url(r"^optimade/v1\.2/links$", views.OptimadeLinksData),
    url(r"^optimade/v1\.2\.0/info$", views.OptimadeInfoData),
    url(r"^optimade/v1\.2\.0/structures$", views.OptimadeStructureList.as_view()),
    url(
        r"^optimade/v1\.2\.0/structures/(?P<pk>[0-9]+)/?$",
        views.OptimadeStructureDetail.as_view(),
    ),
    url(r"^optimade/v1\.2\.0/info/structures$", views.OptimadeStructuresInfoData),
    url(r"^optimade/v1\.2\.0/links$", views.OptimadeLinksData),
